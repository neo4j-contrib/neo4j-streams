...
[NOTE]
====
To allow insertion of keys in any format (e.g. through `streams.publish` procedure) **the key.serializer is set with the org.apache.kafka.common.serialization.ByteArraySerializer**.
