...
For more details about how to use these, please checkout the xref:cud-file-format.adoc#streams_cud_file_format[CUD File Format] section for the
...
You will find a guide <<kafka_ssl, here>> on how to configure Neo4j Streams plugin to work with Kafka over SSL.
