...
[NOTE]
Please note that the new Neo4j Streams versions are backward compatible with the previous Neo4j versions.
For example Neo4j Streams 3.5.12 is compatible with Neo4j 3.5.17.