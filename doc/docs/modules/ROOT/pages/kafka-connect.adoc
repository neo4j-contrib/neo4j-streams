...
| neo4j.batch.timeout.msecs | Integer | false | The execution timeout for the cypher query (default: 30000)
...
| neo4j.encryption.enabled | TRUST_ALL_CERTIFICATES/TRUST_CUSTOM_CA_SIGNED_CERTIFICATES/TRUST_SYSTEM_CA_SIGNED_CERTIFICATES | false | The Neo4j trust strategy (default: TRUST_ALL_CERTIFICATES)
