...
list of options available, see the documentation subsections on the <<neo4j_streams_source,source>> and <<neo4j_streams_sink,sink>>.
...
the <<confluent_cloud, Confluent Cloud>> section
...
For full details on what you can do here, see the <<neo4j_streams_sink,Sink>> section of the documentation.
