...
[source,yaml]
----
include::data/docker-compose-cluster.yml[]
----
...
image::../../images/docker_streams_cluster_example.png[title="Streams Sink plugin into Neo4j+Kafka cluster environment", align="center"]
