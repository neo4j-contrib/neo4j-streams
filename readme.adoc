...
The documentation source for this version lives at https://github.com/neo4j/docs-kafka-streams[this repository]. Please raise any documentation updates by creating a PR against it.
