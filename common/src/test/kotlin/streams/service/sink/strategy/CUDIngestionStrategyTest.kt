...
class CUDIngestionStrategyTest {
    ...
    fun `should create, merge and update nodes`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        ...
        // when
        val cudQueryStrategy = CUDIngestionStrategy(neo4j)
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should create, merge, update and delete nodes with garbage data`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        val mergeMarkers = listOf(2, 5, 7)
        val updateMarkers = listOf(3, 6)
        ...
        val list = (1..10).map {
            val labels = if (it % 2 == 0) listOf(
                "WellBehaved",
                "C̸r̵a̵z̵y̵ ̶.̵ ̶ ̴ ̸ ̶ ̶ ̵ ̴L̴a̵b̸e̶l"
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should create nodes only with valid CUD operations`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        val mergeMarkers = listOf(2, 5, 7)
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should delete nodes with internal id reference`(neo4j: Neo4j, expectedPrefix: String) {
        // given
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should create, merge and update nodes with internal id reference`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        val mergeMarkers = listOf(2, 5, 7)
        val updateMarkers = listOf(3, 6)
        val list = (1..10).map {
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should create, merge and update relationships`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        val mergeMarkers = listOf(2, 5, 7)
        val updateMarkers = listOf(3, 6)
        val key = "key"
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should create and delete relationship also without properties field`(neo4j: Neo4j, expectedPrefix: String) {
        val key = "key"
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should delete relationships`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        val key = "key"
        val list = (1..10).map {
            val labels = if (it % 2 == 0) listOf("Foo", "Bar") else listOf("Foo", "Bar", "Label")
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should delete relationships with internal id reference`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        val key = "_id"
        val list = (1..10).map {
            val labels = if (it % 2 == 0) listOf("Foo", "Bar") else listOf("Foo", "Bar", "Label")
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should create, merge, update and delete nodes with compound keys`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        val mergeMarkers = listOf(2, 5, 7)
        val updateMarkers = listOf(3, 6)
        val deleteMarkers = listOf(10)
    ...
    @ParameterizedTest
    @ArgumentsSource(SupportedVersionsProvider::class)
    fun `should create, merge, update and delete nodes without labels`(neo4j: Neo4j, expectedPrefix: String) {
        // given
        val mergeMarkers = listOf(2, 5, 7)
        val updateMarkers = listOf(3, 6)
        val deleteMarkers = listOf(10)
